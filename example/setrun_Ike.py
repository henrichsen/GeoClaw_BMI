...
def setrun(claw_pkg='geoclaw'):
    ...
    if clawdata.output_style == 1:
        ...
        recurrence = 1  #do not output times
   ...
   # rundata.regiondata.regions.append([12, 15, 8000., 26000., -95.5,-94,-29,-31])
    ...
    rundata.regiondata.regions.append([6, 6, -259200, 756000,-96.5,-93.5,28.5, 31.5])
    ...
    rundata.gaugedata.gauges.append([12, -94.6922, 29.6516,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
  #  rundata.gaugedata.gauges.append([13, -94.5587, 29.7694,
   #                                  rundata.clawdata.t0,
    #                                 rundata.clawdata.tfinal])
    rundata.gaugedata.gauges.append([13, -94.5295, 29.8751,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    
    rundata.gaugedata.gauges.append([14, -94.5065, 29.5994,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
   # rundata.gaugedata.gauges.append([16, -94.5162, 29.7610,
    #                                 rundata.clawdata.t0,
     #                                rundata.clawdata.tfinal])
    rundata.gaugedata.gauges.append([15, -94.5332, 29.9467,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
...
def setgeo(rundata):
  ...
  #  clawutil.data.get_remote_file(
   ...
   # topo_data.topofiles.append([3, topo_path])
    ...
    ike.time_offset = datetime.datetime(2008, 9, 10, 7)
